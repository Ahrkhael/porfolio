          ...
          <div className="flex justify-center gap-4">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-8 h-8 text-blue-400 md:text-gray-300 hover:text-(--font-color-menu-secondary) transition-colors duration-200 mx-[20px]"
              >
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-8 h-8 text-blue-400 md:text-gray-300 hover:text-(--font-color-menu-secondary) transition-colors duration-200"
              >
