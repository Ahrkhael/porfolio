  ...
  return (
    <>
      <div className={clsx("w-full md:w-1/2 lg:pl-20 md:pl-10")}>
        ...
        <p className="">{job}</p>
        <p className="">{t("Email") + email}</p>
        <p className="">{t("Phone") + phone}</p>
        <div className="flex gap-4 mt-4">
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-8 h-8 text-gray-500 hover:text-blue-600 transition-colors duration-200 mx-[20px]"
            >
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-8 h-8 text-gray-500 hover:text-blue-600 transition-colors duration-200"
            >
