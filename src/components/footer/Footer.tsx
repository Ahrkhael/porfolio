        ...
        <div className="flex justify-center mt-4 gap-6">
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-8 h-8 text-blue-400 md:text-(--font-color-secondary) hover:text-blue-600 transition-colors duration-200 mx-[20px]"
            >
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-8 h-8 text-blue-400 md:text-(--font-color-secondary) hover:text-blue-600 transition-colors duration-200"
            >
